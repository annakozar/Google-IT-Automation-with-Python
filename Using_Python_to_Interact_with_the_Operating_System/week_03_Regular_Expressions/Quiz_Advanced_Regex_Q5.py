#The convert_phone_number function checks for a U.S. phone number format: xxx-xxx-xxxxx 
#(3 digits followed by a dash, 3 more digits followed by a dash, and 4 digits), and converts 
#it to a more formal format that looks like this: (xxx) xxx-xxxx. Fill in the regular 
